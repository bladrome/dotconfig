...
local widget_systray = wibox.widget{
    {
        {
            ...
            left = dpi(widget_systray_margin),
            right = dpi(widget_systray_margin),
            top = dpi(widget_systray_margin),
            bottom = dpi(widget_systray_margin),
            widget = wibox.container.margin
        },
    ...
    margins = dpi(widget_systray_margin),
    widget = wibox.container.margin
}
