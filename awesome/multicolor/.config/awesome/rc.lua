...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "s", function() os.execute("_tmpshotfile=~/Pictures/screenshot-$(date +%F-%H-%M-%S).png; maim -m 9 -u -s $_tmpshotfile; xclip -sel c -t image/png < $_tmpshotfile") end,
