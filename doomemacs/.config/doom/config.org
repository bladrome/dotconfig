...
(setq font-size
      (if (string= (system-name) "penguin")
          40
        20))
(setq doom-font (font-spec :family "SauceCodePro Nerd Font Mono" :size font-size)
      doom-variable-pitch-font doom-font
      doom-symbol-font (font-spec :family "VictorMono")
      doom-big-font (font-spec :family "VictorMono" :size (+ font-size 6)))
...
(use-package! org-fragtog
  ...
  (org-format-latex-options
   (plist-put org-format-latex-options :scale (/ (frame-char-height) 10))
...
(use-package! aidermacs
  ...
  :config
  (setenv "OPENAI_API_KEY" (shell-command-to-string "pass show moenetkey"))
  (setenv "OPENAI_API_BASE" "openai.moenet.top/v1")
  (setq aidermacs-extra-args `("--openai-api-base"
                               " https://openai.moenet.top/v1/"
                               ;; "--verbose"
                               "--openai-api-key"
                               ,(shell-command-to-string "pass show moenetkey")))
  :custom
  (aidermacs-default-model "openai/auto"))
...
(after! org-re-reveal
  :config
  (setq org-re-reveal-root (file-relative-name  (concat org-directory "style"))
